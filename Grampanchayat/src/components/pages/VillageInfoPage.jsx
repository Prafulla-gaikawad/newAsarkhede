            ...
            <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 leading-relaxed mb-6">
                  आसारखेडे हे एक समृद्ध व शांत गाव आहे, जिथे शेती, परंपरा आणि
                  एकतेला महत्त्व दिले जाते. गावात साक्षरतेचा दर उच्च आहे आणि
                  शिक्षणाचा दर्जा चांगला आहे. स्वतःची ग्रामपंचायत असल्याने
                  स्थानिक पातळीवर प्रशासनाची सुविधा उपलब्ध आहे.
                </p>

                <h3 className="text-2xl font-bold text-gray-800 mb-4">स्थान</h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                  At/Post-आसारखेडे खु, तालुका-चांदवड, जिल्हा-नाशिक
                </p>
